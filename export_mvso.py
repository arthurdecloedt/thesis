...
class KitModel(nn.Module):
    ...
    def __init__(self, weight_file):
        ...
        self.fc8_en_1 = self.__dense(name = 'fc8_en_1', in_features = 4096, out_features = 4342, bias = True)
    ...
    def forward(self, x):
        ...
        fc8_en_0        = drop7.view(drop7.size(0), -1)
        fc8_en_1        = self.fc8_en_1(fc8_en_0)
        return fc8_en_1
